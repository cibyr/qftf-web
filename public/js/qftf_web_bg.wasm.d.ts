...
export const qftfnode_spawn: () => number;
export const qftfnode_node_id: (a: number, b: number) => void;
export const qftfnode_trigger_qftf: (a: number, b: number, c: number, d: number, e: number) => number;
